...
import './PersonaEditar.css';
import usuario from '../Imagenes/usuario.png';

function PersonaEditar() {

  return (
    <div>
      <div className='personaEditar'>
      ...
      <select  style = {{position: 'absolute', top: 480, left: 850, fontSize: 20, fontWeight: 'bold', color:'black'}}> >
        ...
        <button  className='editarPersonal'>Editar</button>
        <button  className='volverPersonaEditar' >Volver</button>
